...
# s.license      = { :type => "MIT", :file => "FILE_LICENSE" }
  ...
  # Or just: s.author    = "丰文佳"
  # s.authors            = { "丰文佳" => "xiaofeng20150227@gmail.com" }
  # s.social_media_url   = "http://twitter.com/丰文佳"
  ...
  s.source       = { :git => "https://github.com/xiaofeng2013/GKUtils.git", :tag => "0.1.0" }
